...
| **Code04** :negative_squared_cross_mark: | 代码可靠性   | 是否利用异常与断言进行防御式编程或契约式设计（可选）         | 的确是缺憾，但感觉不是很好补                                 |
| **Code05** :negative_squared_cross_mark: | 单元测试代码 | 检查是否有单元测试代码                                       | 真的不好补                                                   |
...
| *Doc25*  ::negative_squared_cross_mark: | 测试用例覆盖种类是否齐全                                     | 单元测试，集成测试，系统测试                                 |                |
